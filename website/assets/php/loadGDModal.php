...
if ($q == "Bullock.Sam") {
  echo $GDHead['Bullock.Sam'];
echo $GDWebLink['Bullock.Sam'];
echo $GDWorkLink['Bullock.Sam'];
echo $GDLinkedinLink['Bullock.Sam'];
echo $GDFooter['Bullock.Sam'];
}
if ($q == "Filzer.Zoe") {
