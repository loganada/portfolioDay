...
echo "<span class='imageBorder student-overlay'>
		<img class='picture' onclick='modalDisplay()' id ='video $i' width='200px'  src='assets/img/finalPicsVideo/".$arrayVideo[$i]['bio_last_name'] . ".". $arrayVideo[$i]['bio_first_name'] .".jpg'/>
